    ...
    <>
      <div className="flex lg:flex-row  flex-col-reverse">
        <div className="basis-2/3 dark:text-white pb-5">
          <h1 className="lg:text-5xl text-center lg:text-start text-3xl mt-5 lg:mt-0 font-bold "  data-aos="fade-right">{`I'm`} {data?.data_info?.name}</h1>
          <h2 className="lg:text-5xl text-xl text-center lg:text-start font-bold mt-2" data-aos="fade-left">
            <span className="text-yellow-500 text-5xl">{data?.data_info?.major} </span>
            <span>{data?.data_info?.position}</span>
          </h2>
          <p className="mt-5 text-sm text-center lg:text-start text-gray-500" data-aos="fade-up">
            {data?.data_info?.description}
          </p>
          <div className="flex justify-center lg:justify-start">
            <a
              href={data?.data_info?.cv}
        ...
        <div className="lg:ml-10 ml-3 flex justify-center lg:justify-start flex-shrink-0" data-aos="flip-left">
          <img className="w-[200px] object-cover" src={data?.data_info?.img_background} alt="" />
        </div>
      </div>
      <div>
